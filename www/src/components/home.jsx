    ...
    <div className="container" role="main">
      ...
      <div className="jumbotron">
        ...
        <p className="lead">
          ...
          <br/><br/>
          Ci-dessous la liste des documents ISTEX proposés dans ce prototype qui proposera dans un premier temps un service de références bibliographiques interactives au survol de la souris.
        </p>
      </div>
